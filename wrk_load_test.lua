...
local peer_ids = { '-DE9824-143964258012', '-LT6582-219658122842', '-qB3172-387629572328', '-TR7853-006596431845', '-UT3925-577132654008', '-AZ6241-914123275031', '-BC8334-123456789012', '-JJ1202-210987654321', '-YT7118-101010101010', '-NM1111-867530941237' }
...
request = function()
    ...
    random_peer = peer_ids[math.random(#peer_ids)]
    ...
    url_path = "/announce?info_hash="..rand_hash.."&peer_id="..random_peer.."&port=6881&uploaded="..uploaded.."&downloaded="..downloaded.."&left=727955456&event="..rand_event.."&numwant=30&no_peer_id=1&compact=1"
